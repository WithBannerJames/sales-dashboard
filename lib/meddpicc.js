...
// Bump when the extraction prompt or scoring rules change, so every stored analysis is treated
// as stale and re-run rather than silently serving results judged by older rules.
//   1: initial extraction
//   2: explicit met flag (prose about a shortfall no longer counts as captured), Banner staff
//      can never satisfy an element, elements must agree with the stage-exit assessment
